...
### Remote tier, BLOCKER (see BLOCKERS.md B1)
...
NOT STARTED, blocked on remote capacity (BLOCKERS.md B1). No optimization work may claim victory before the profile exists. Local-tier prep (build, parity fixtures, day-0 code study) proceeds in parallel.
